...
artefact:
  ...
  ko: >-
    ...
    "4단계 중 3단계"라는 줄과 채워진 칸 두 개가 있습니다. 분류에 "고객사
    출장", 금액에 "₩184,000"입니다. 그리고 왼쪽에 "이전", 오른쪽에 파란
    "계속"이 있는 맨 아래 줄이 있습니다. 두 번째에는 "6단계 중 4단계"라는 줄과
    칸 두 개가 있습니다. 영수증에 "receipt-0812.pdf", 결재자에 "윤서진"입니다.
    그리고 같은 맨 아래 줄이 있습니다.
sequence:
  - caption:
