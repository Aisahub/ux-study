...
artefact:
  ...
  ko: >-
    리포트 도구의 세 상태입니다. 첫 번째는 "저장한 리포트" 화면으로,
    "40개 선택됨"이라고 적힌 줄 옆에 "보관" 버튼과 "내보내기" 버튼이 있고, 그 아래 표의 각 행에
    ...
    다른 리포트 두 개가 있고, 그 아래 짙은 색 메시지에
    "리포트 40개를 보관했습니다"라고만 적혀 있을 뿐 누를 것은 없습니다.
sequence:
  - caption:
