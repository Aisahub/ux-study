...
artefact:
  ...
  ko: >-
    ...
    단계에서 다시 보이지 않아, 결제 전에 맞는지 대조해 볼 것이 없다
    (일관성).", "3. 결제 단계에서 브라우저 뒤로 가기를 누르면 장바구니가
    비는데, 아무런 경고도 없고 되돌릴 방법도 없다 (비상구).", "4. '주문하기'
    버튼이 휴대폰에서 첫 화면 아래로 밀려, 375px 화면에서는 페이지를 열었을 때
    보이지 않는다 (시각적 위계)."
screen:
  en: |-
    <div class="screen">
