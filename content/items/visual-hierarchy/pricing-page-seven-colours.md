...
artefact:
  en: >-
    A pricing page for a booking product, using seven colours. Navy carries the
    top bar and every section heading. Teal carries the "Start free trial"
    button and the border around whichever plan is selected. Amber carries a
    "Most popular" tag on the middle plan. Light grey carries the plan-card
    backgrounds and the alternating rows of the comparison table. Purple
    carries a band behind the FAQ. Green carries the words "Save 20%" beside
    the annual toggle. Red carries the footer links.
  ko: >-
    예약 서비스의 요금제 페이지이고, 색을 일곱 가지 씁니다. 남색은 상단 바와
    모든 섹션 제목에 씁니다. 청록색은 "무료로 시작하기" 버튼과 지금 선택된
    요금제의 테두리에 씁니다. 주황색은 가운데 요금제에 붙은 "가장 인기"
...
prompt:
  en: >-
    ...
    colours. Which two belong as the primaries?
  ko: >-
    이 페이지의 색을 주색 둘, 보조색 둘로 줄이려고 합니다. 주색으로 남겨야 할
    두 색은 무엇일까요?
options:
  en:
    - text: Navy and teal
