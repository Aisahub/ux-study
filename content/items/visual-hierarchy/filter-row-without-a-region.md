...
artefact:
  ...
  ko: >-
    ...
    하나 안에 함께 들어 있습니다. 그 패널 아래에는 컨트롤 다섯 개가 한 줄로 떠
    있습니다. 기간, 고객사, 상태, 통화, 그리고 초기화 링크입니다. 주위에
    그려진 것은 아무것도 없고 위아래 여백은 16px로, 이 페이지가 다른 곳에서
    쓰는 간격과 똑같습니다. 그 아래에 리포트 표가 있고, 표 밑에 페이지 이동이
    있습니다.
screen:
  en: |-
...
options:
  ...
  ko:
    - text: 컨트롤 다섯 개를 테두리 영역 하나에 담습니다
      reason: >-
        요약 카드가 이미 그런 것과 같습니다. 페이지의 나머지는 그대로 둡니다.
      correct: true
