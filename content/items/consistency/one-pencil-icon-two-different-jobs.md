...
artefact:
  ...
  ko: >-
    ...
    목록에서는 보드 이름을, 연락처 목록에서는 연락처 이름을 바꿉니다. 두 번째
    화면에는 문서가 열려 있고, 상단 도구 막대에 같은 연필 아이콘이 있는데,
    거기서는 자유롭게 손으로 그리는 주석 도구로 전환됩니다. 두 연필 모두 같은
    크기의 똑같은 모양이고, 어느 쪽에도 글자 이름은 없습니다.
screen:
  en: |-
    <div class="split">
      <div>
