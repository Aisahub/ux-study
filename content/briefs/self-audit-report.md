...
whatCounts:
  ...
  ko: >-
    ...
    페이지를 쓰는 사람에게 무엇이 문제인지 적은 설명, 고치는 방법 제안입니다.
    요소는 말로 설명하지 않고 페이지에서 직접 가리켜 고르고, 원칙은 용어집에서
    고릅니다. 네 부분 모두 모든 발견에 필수이며, 두 발견이 같은 요소를 가리킬
    수 없습니다.
advice:
  en: >-
    ...
    you press it.
  ko: >-
    설명은 우리가 읽으라고 쓰는 것이 아니라, 페이지를 쓰는 사람이 읽으라고
    쓰세요. 그 사람에게 무엇이, 언제 잘못되는지 말입니다. 고치는 방법은 기발할
