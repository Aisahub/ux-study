...
whatCounts:
  ...
  ko: >-
    ...
    부분으로 이루어집니다. 문제의 요소(말로 설명하는 것이 아니라 페이지에서
    직접 가리켜 선택합니다); 그 요소가 어기고 있는 UX 원칙(용어집에서
    선택합니다); 페이지를 쓰는 사람에게 무엇이 문제인지에 대한 설명; 그리고
    고치는 방법 제안. 네 부분 모두 모든 발견에 필수이며, 두 발견이 같은 요소를
    가리킬 수 없습니다.
advice:
  en: >-
