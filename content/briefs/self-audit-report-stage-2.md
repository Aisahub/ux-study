...
whatCounts:
  ...
  ko: >-
    ...
    흐름 안에서 직접 가리켜 선택합니다); 그 요소가 어기고 있는 UX
    원칙(용어집에서 선택합니다); 그것을 쓰는 사람에게 무엇이 잘못되는지에 대한
    설명; 그리고 고치는 방법 제안. 네 부분 모두 모든 발견에 필수이며, 두
    발견이 같은 요소를 가리킬 수 없습니다. 여러 단계에 걸쳐 나오는 컨트롤은
    단계마다 서로 다른 요소이므로, 같은 버튼의 서로 다른 두 순간은 하나가
    아니라 두 개의 발견입니다.
advice:
  en: >-
