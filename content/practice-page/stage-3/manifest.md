  ...
  - slug: consent-hangs-on-two-letters
    ...
    explanation:
      ...
      ko: >-
        ...
        문장에서 40분, 한 명, 6개월, 제품팀만이라는 나머지 정보는 전부 판단할
        수 있습니다. 유일하게 해독할 수 없는 말이 하필 동의해 달라고 부탁하는
        대목에 붙어 있고, 녹화를 모아 두는 곳이 무엇을 하는 곳인지 알 수 없는
        사람에게 남는 선택지는 짐작하거나 페이지를 닫는 것뿐입니다. 마주치는
        그 자리에서 "사용성 테스트"라고 풀어 써야 합니다.
  ...
  - slug: told-it-is-the-app-she-already-knows
    ...
    explanation:
      ...
      ko: >-
        ...
        아니라 저희가 만든 어긋남에 시간을 다 씁니다. 들어오시기 전에 알려야
