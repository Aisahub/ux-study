...
> = {
  ...
  ko: {
    heading: '동료들이 찾아낸 것',
    explanation:
      '내가 감사를 마친 페이지에 제출된 Finding을, 동의한 동료 수 순서로 보여 줍니다. 아직 제출하지 않은 단계는 여기 없습니다 — 제출 전에는 정답지가 되기 때문입니다. 동의는 명확하게 표현된 Finding을 드러낼 뿐, 아무것도 잠그지 않고 사람별로 합산되지도 않습니다.',
    board: '가장 많이 동의받은 Finding',
    agreementCount: (n) => `동의 ${n}명`,
    by: '작성',
    stage: (n) => `${n}단계`,
    empty: '이 단계에 보고서를 제출한 동료가 아직 없습니다 — 여러분이 처음입니다. 동료들이 마치는 대로 여기에 나타납니다.',
  },
}
