...
> = {
  ...
  ko: {
    heading: '내 메모',
    explanation:
      '이 역량에서 남겨 두고 싶은 내용을 기록하는 공간입니다. 기사에서 얻은 한 줄, 그 말이 그대로 들어맞는 우리 제품 화면, 리뷰에서 활용할 문장 등을 적을 수 있습니다. 본인만 볼 수 있으며, 동료와 운영자에게 공개되지 않고 어디에도 반영되지 않습니다.',
    label: '새 메모',
    placeholder: '이 역량에서 무엇을 얻으셨나요?',
    add: '메모 추가',
    adding: '추가하는 중…',
